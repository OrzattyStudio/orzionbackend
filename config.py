...
class Config:
    ...
    ORZION_TURBO_MODEL = os.getenv("ORZION_TURBO_MODEL", "minimax/minimax-m2:free")
    ORZION_TURBO_MODEL_SECONDARY = os.getenv("ORZION_TURBO_MODEL_SECONDARY", "minimax/minimax-m2:free")
    ...
    ORZION_MINI_MODEL = os.getenv("ORZION_MINI_MODEL", "meta-llama/llama-3.3-8b-instruct:free")
    ORZION_MINI_MODEL_SECONDARY = os.getenv("ORZION_MINI_MODEL_SECONDARY", "meta-llama/llama-3.3-8b-instruct:free")
